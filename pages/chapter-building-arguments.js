...
export default function ChapterBuildingArguments() {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            {sidebarChapters.map((chapter, idx) => (
              <li key={chapter.title}>
                <Link href={chapter.link} legacyBehavior>
                  <a className={`block px-3 py-2 rounded-lg font-medium transition-colors duration-200 ${idx === 1 ? "bg-black text-white" : "text-gray-700 hover:bg-gray-100"}`}>
                    {chapter.title}
                  </a>
                </Link>
              </li>
      ...
      <main className="flex-1 flex justify-center py-10 px-2 md:px-8">
        <div className="w-full max-w-3xl bg-white border border-gray-200 shadow-lg rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2">🧱 Chapter 2: <span className="font-extrabold">Building Arguments</span></h1>
          <hr className="my-4 border-gray-300" />

          {/* Section 1 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🎯 1. What is an Argument?</h2>
          <p className="mb-4 text-gray-800">An argument is a logical statement that supports your side of the debate. It's not about who shouts louder — it's about who makes more sense.</p>

          <h3 className="font-semibold mt-4 mb-1">🧩 The ARE Structure:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Assertion:</b> What are you claiming?</li>
            <li><b>Reasoning:</b> Why is it true?</li>
            <li><b>Evidence:</b> What proves it?</li>
          </ul>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
            <span className="font-bold">🧠 Example:</span><br />
            <span>"Social media harms mental health."<br />
            <b>Assertion:</b> It negatively affects mental health.<br />
            <b>Reasoning:</b> It causes comparison and anxiety.<br />
            <b>Evidence:</b> Studies show a rise in depression among heavy users.</span>
          </div>

          {/* Section 2 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🧠 2. Types of Arguments</h2>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Logical</b> – Based on reasoning</li>
            <li><b>Emotional</b> – Appeals to values or empathy</li>
            <li><b>Factual</b> – Based on statistics/data</li>
            <li><b>Moral</b> – Based on ethics and principles</li>
          </ul>

          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
            <span className="font-bold">🎲 Try This:</span><br />
            <span>Write 1 moral and 1 logical argument for:<br />
            <b>"This house would ban animal testing."</b></span>
          </div>

          {/* Section 3 */}
          <h3 className="font-semibold mt-4 mb-1">💡 Tips to Build Better Arguments:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Avoid vague claims</li>
            <li>Stay consistent</li>
            <li>Always link back to the motion</li>
          </ul>
            ...
            <div className="bg-green-50 p-6 rounded-lg border-2 border-green-200">
              <div className="text-center">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Link href="/chapter-rebuttal-techniques" legacyBehavior>
          ...
          <div className={`p-4 my-4 rounded-lg border-l-4 ${
            ...
            <span className="font-bold">
              {quizCompleted ? '🏗️' : '🧱'} {quizCompleted ? 'Master Builder' : 'Builder Brain'}
            </span> 
            <span className="block mt-1">
              {quizCompleted 
                ? 'Congratulations! You mastered the ARE structure!' 
