...
export default function ChapterJudgingCriteria() {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            {sidebarChapters.map((chapter, idx) => (
              <li key={chapter.title}>
                <Link href={chapter.link} legacyBehavior>
                  <a className={`block px-3 py-2 rounded-lg font-medium transition-colors duration-200 ${idx === 5 ? "bg-black text-white" : "text-gray-700 hover:bg-gray-100"}`}>
                    {chapter.title}
                  </a>
                </Link>
              </li>
      ...
      <main className="flex-1 flex justify-center py-10 px-2 md:px-8">
        <div className="w-full max-w-3xl bg-white border border-gray-200 shadow-lg rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2">⚖️ Chapter 6: <span className="font-extrabold">Judging Criteria</span></h1>
          <hr className="my-4 border-gray-300" />

          {/* Section 1 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🎯 1. The 3 M's of Judging</h2>
          <p className="mb-4 text-gray-800">Debate judges use three main criteria to evaluate speakers: <b>Matter</b>, <b>Method</b>, and <b>Manner</b>. Understanding these helps you improve.</p>

          <h3 className="font-semibold mt-4 mb-1">💡 The Three M's:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Matter</b> – What you say (content, arguments, evidence)</li>
            <li><b>Method</b> – How you organize it (structure, logic, flow)</li>
            <li><b>Manner</b> – How you present it (delivery, style, engagement)</li>
          </ul>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
            <span className="font-bold">🧠 Pro Tip:</span><br />
            <span>Most judges weigh <b>Matter</b> (50%), <b>Method</b> (30%), and <b>Manner</b> (20%). Focus on strong arguments first!</span>
          </div>

          {/* Section 2 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">📊 2. Detailed Criteria Breakdown</h2>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Clarity</b> – How well you communicate your ideas</li>
            <li><b>Logic</b> – Quality of reasoning and evidence</li>
            <li><b>Engagement</b> – How well you connect with the audience</li>
            <li><b>Rebuttal</b> – How effectively you respond to opponents</li>
            <li><b>Time Management</b> – Using your allocated time well</li>
          </ul>

          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
            <span className="font-bold">🎲 Practice Tip:</span><br />
            <span>Ask experienced debaters to judge your practice rounds and give feedback on these criteria.</span>
          </div>

          {/* Section 3 */}
          <h3 className="font-semibold mt-4 mb-1">💡 Common Judging Mistakes:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Focusing too much on speaking speed</li>
            <li>Ignoring the quality of arguments</li>
            <li>Being biased toward certain topics</li>
            <li>Not considering the debate as a whole</li>
            <li>Forgetting to evaluate rebuttal effectiveness</li>
          </ul>
              ...
              <div className="text-center">
                ...
                <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-yellow-800 text-sm">
                    🏆 Congratulations! You've completed all chapters! You're now a debate master!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`p-4 my-4 rounded-lg border-l-4 ${
            ...
            <span className="font-bold">
              {quizCompleted ? '⚖️' : '📊'} {quizCompleted ? 'Judging Master' : 'Judging Apprentice'}
            </span> 
            <span className="block mt-1">
              {quizCompleted 
                ? 'Congratulations! You mastered judging criteria!' 
