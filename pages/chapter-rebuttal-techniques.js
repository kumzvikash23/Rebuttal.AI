...
export default function ChapterRebuttalTechniques() {
  ...
  const quizData = {
    ...
    rightColumn: [
      "Directly attack opponent's argument",
      "Ask a question during opponent's speech",
      "Present opposing evidence",
      "Use opponent's argument against them",
      "Add new arguments to existing ones",
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            {sidebarChapters.map((chapter, idx) => (
              <li key={chapter.title}>
                <Link href={chapter.link} legacyBehavior>
                  <a className={`block px-3 py-2 rounded-lg font-medium transition-colors duration-200 ${idx === 2 ? "bg-black text-white" : "text-gray-700 hover:bg-gray-100"}`}>
                    {chapter.title}
                  </a>
                </Link>
              </li>
      ...
      <main className="flex-1 flex justify-center py-10 px-2 md:px-8">
        <div className="w-full max-w-3xl bg-white border border-gray-200 shadow-lg rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2">🥊 Chapter 3: <span className="font-extrabold">Rebuttal Techniques</span></h1>
          <hr className="my-4 border-gray-300" />

          {/* Section 1 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🎯 1. What is Rebuttal?</h2>
          <p className="mb-4 text-gray-800">Rebuttal is the art of <b>responding to your opponent's arguments</b>. It's not just saying "you're wrong" — it's showing why their logic fails.</p>

          <h3 className="font-semibold mt-4 mb-1">💡 Why Rebuttal Matters:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Shows you're listening</li>
            <li>Demonstrates critical thinking</li>
            <li>Weakens opponent's case</li>
            <li>Strengthens your position</li>
          </ul>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
            <span className="font-bold">🧠 Example:</span><br />
            <span><b>Opponent:</b> "Social media is good because it connects people."<br />
            <b>Your Rebuttal:</b> "While it connects people, studies show it actually increases loneliness and depression."</span>
          </div>

          {/* Section 2 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">⚔️ 2. Types of Rebuttal</h2>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Direct Rebuttal</b> – Attack the argument head-on</li>
            <li><b>Point of Information (POI)</b> – Ask questions during their speech</li>
            <li><b>Counter-Argument</b> – Present opposing evidence</li>
            <li><b>Turn</b> – Use their argument against them</li>
          </ul>

          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
            <span className="font-bold">🎲 Try This:</span><br />
            <span>Practice a <b>turn</b> on this argument:<br />
            <b>"Homework should be banned because it takes away family time."</b></span>
          </div>

          {/* Section 3 */}
          <h3 className="font-semibold mt-4 mb-1">💡 Tips for Effective Rebuttal:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Listen carefully to opponent's arguments</li>
            <li>Take notes during their speech</li>
            <li>Address their strongest points first</li>
            <li>Use specific examples and evidence</li>
            <li>Stay respectful and logical</li>
          </ul>
            ...
            <div className="bg-green-50 p-6 rounded-lg border-2 border-green-200">
              <div className="text-center">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Link href="/chapter-public-speaking-skills" legacyBehavior>
          ...
          <div className={`p-4 my-4 rounded-lg border-l-4 ${
            ...
            <span className="font-bold">
              {quizCompleted ? '⚔️' : '🥊'} {quizCompleted ? 'Rebuttal Master' : 'Rebuttal Rookie'}
            </span> 
            <span className="block mt-1">
              {quizCompleted 
                ? 'Congratulations! You mastered rebuttal techniques!' 
