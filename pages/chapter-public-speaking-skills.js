...
export default function ChapterPublicSpeakingSkills() {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
            ...
            {sidebarChapters.map((chapter, idx) => (
              <li key={chapter.title}>
                <Link href={chapter.link} legacyBehavior>
                  <a className={`block px-3 py-2 rounded-lg font-medium transition-colors duration-200 ${idx === 3 ? "bg-black text-white" : "text-gray-700 hover:bg-gray-100"}`}>
                    {chapter.title}
                  </a>
                </Link>
              </li>
      ...
      <main className="flex-1 flex justify-center py-10 px-2 md:px-8">
        <div className="w-full max-w-3xl bg-white border border-gray-200 shadow-lg rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2">🎤 Chapter 4: <span className="font-extrabold">Public Speaking Skills</span></h1>
          <hr className="my-4 border-gray-300" />

          {/* Section 1 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🎯 1. Why Public Speaking Matters</h2>
          <p className="mb-4 text-gray-800">Great arguments are worthless if no one can understand them. Public speaking is about <b>delivering your message clearly and persuasively</b>.</p>

          <h3 className="font-semibold mt-4 mb-1">💡 Key Benefits:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Builds confidence</li>
            <li>Improves communication</li>
            <li>Enhances leadership skills</li>
            <li>Makes arguments more persuasive</li>
          </ul>

          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
            <span className="font-bold">🧠 Remember:</span><br />
            <span>Even the best debaters get nervous. The key is to <b>channel that energy</b> into enthusiasm, not fear.</span>
          </div>

          {/* Section 2 */}
          <h2 className="text-2xl font-semibold mt-8 mb-2">🎭 2. Essential Speaking Skills</h2>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li><b>Eye Contact</b> – Connect with your audience</li>
            <li><b>Voice Modulation</b> – Vary tone, pitch, and volume</li>
            <li><b>Body Language</b> – Use posture and movement</li>
            <li><b>Pacing</b> – Control your speaking speed</li>
            <li><b>Gestures</b> – Use hands to emphasize points</li>
          </ul>

          <div className="bg-blue-50 border-l-4 border-blue-400 p-4 my-4">
            <span className="font-bold">🎲 Practice Tip:</span><br />
            <span>Record yourself speaking and watch it back. Notice your body language and voice patterns.</span>
          </div>

          {/* Section 3 */}
          <h3 className="font-semibold mt-4 mb-1">💡 Overcoming Nervousness:</h3>
          <ul className="list-disc ml-8 mb-2 text-gray-800">
            <li>Practice, practice, practice</li>
            <li>Breathe deeply before speaking</li>
            <li>Focus on your message, not yourself</li>
            <li>Remember: everyone gets nervous</li>
            <li>Start with smaller audiences</li>
          </ul>
            ...
            <div className="bg-green-50 p-6 rounded-lg border-2 border-green-200">
              <div className="text-center">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <Link href="/chapter-debate-formats" legacyBehavior>
          ...
          <div className={`p-4 my-4 rounded-lg border-l-4 ${
            ...
            <span className="font-bold">
              {quizCompleted ? '🎤' : '🎭'} {quizCompleted ? 'Orator Master' : 'Public Speaker'}
            </span> 
            <span className="block mt-1">
              {quizCompleted 
                ? 'Congratulations! You mastered public speaking skills!' 
